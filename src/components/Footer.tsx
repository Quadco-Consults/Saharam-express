      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-saharan-500 rounded-full flex items-center justify-center">
                <Car className="w-6 h-6" />
              </div>
              <div>
                <h3 className="text-2xl font-bold">Saharan Express</h3>
                <p className="text-saharan-200 text-sm">EXPRESS LIMITED</p>
              </div>
            </div>
            ...
            <p className="text-saharan-400 italic">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-saharan-400 transition-colors">
                  Book a Trip
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-saharan-400" />
                <span className="text-gray-300">+234 701 234 5678</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-saharan-400" />
                <span className="text-gray-300">info@saharamexpress.com.ng</span>
              </div>
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-saharan-400 mt-1" />
        ...
        <div className="border-t border-gray-700 pt-8 mt-12 text-center">
          <p className="text-gray-400">
            © 2024 Saharan Express Limited. All rights reserved. |
            <span className="ml-2">
              <a href="#" className="hover:text-saharan-400 transition-colors">Privacy Policy</a>
              {' '} | {' '}
              <a href="#" className="hover:text-saharan-400 transition-colors">Terms of Service</a>
            </span>
          </p>
        </div>
      </div>
